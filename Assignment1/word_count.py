...
class WordCount:
    ...
    def word_report(self, filename = None, encoding = "utf-8", special_chars=None):
        try:
...
if __name__ == "__main__":
    ...
    wc.generate_report(write_file, word_count, unique = True, word_dct = False, get_words = True)
